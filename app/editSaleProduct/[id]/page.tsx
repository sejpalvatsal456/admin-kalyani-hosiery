...
export default function EditSaleProductPage() {
  ...
  const [form, setForm] = useState<SaleProductInput>({
    brandId: "",
    productName: "",
    categoryId: "",
    subcategoryId: "",
  ...
  const handleChange = (field: keyof SaleProductInput, value: any) => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 p-8">
        <div className="rounded-3xl bg-white px-8 py-6 shadow-lg text-slate-700">
          Loading...
        </div>
      </div>
    );
        ...
        <form onSubmit={handleSubmit} className="space-y-8 px-6 py-8 sm:px-10">
          ...
          <section className="rounded-[28px] border border-slate-200 bg-slate-50 p-6 shadow-sm">
            <div className="space-y-6">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">Update key-value description pairs.</p>
              </div>
          ...
          <section className="rounded-[28px] border border-slate-200 bg-slate-50 p-6 shadow-sm">
            <div className="space-y-6">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">Update tags for this sale product.</p>
              </div>
          ...
          <div className="flex flex-wrap justify-between gap-4">
            <div className="flex gap-3">
              ...
              <button
                type="button"
                onClick={() => router.push(`/editSaleVarient/${productId}`)}
                className="rounded-full bg-blue-600 px-6 py-3 text-white hover:bg-blue-700 shadow-md"
              >
                Edit Variants →
              </button>
            </div>
