        ...
        <form onSubmit={handleSubmit} className="space-y-8 px-6 py-8 sm:px-10">
                ...
                <div className="flex gap-4 flex-col md:flex-row">
                  ...
                  <div className="flex flex-col gap-2">
                    <button
                      ...
                      className="w-40 rounded-2xl border border-blue-300 bg-blue-50 px-4 py-3 text-blue-700"
                    >
                    ...
                    {form.thumbnail && (
                      <button
                        ...
                        className="w-40 rounded-2xl border border-slate-300 px-4 py-3"
                      >
                        Clear
                      </button>
                    )}
          ...
          <div className="flex flex-wrap justify-between gap-4">
            ...
            <div className="flex gap-3">
              ...
              <button
                type="button"
                onClick={() => router.push(`/editVarient/${productId}`)}
